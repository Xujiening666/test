...
#define MODE_DISKUPDATE_EN                  1       //设备升级固件模式
...
#define VOLUME_DEFAULT                      60      //默认音量值
#define VOLUME_MIN                          60      //开机最小音量值
...
#define BT_NAME_DEFAULT                     "SL-EARPHONE"                       //蓝牙设备默认名字
...
#define FM_CLK_PIN_SEL                      0       //0:none; 1:PB12; 2:PB1; 3:PB8; 4:PB13; 5:PC4; 6:PD0;
...
#define UART0_BAUDRATE                      3000000 //波特率
#define UART0_SCLK_FREQ                     48000000
#define UART0_TX_PIN_SEL                    1       //0:PB1; 1:PB3; 2:PB6; 3:PB8; 4:PB9; 5:PD0; 6:--; 7:--; 8:PB11; 9:PB13;
#define UART0_RX_PIN_SEL                    0       //0:PB4; 1:PB10; 2:PD1; 3:--; 4:PB12;
...
#define TONE_LINEIN_MODE_EN                 1       //linein模式提示音
...
#define TONE_MUSIC_NEXT_EN                  1       //音乐模式下一首提示音
#define TONE_MUSIC_PREV_EN                  1       //音乐模式上一首提示音
...
#define KEY_PMU_MULTFUC_EN                  1       //ONOFF用作多功能键（包括单击、双击、长按）
...
#define PIN_KIO0                            PIN_B9  //V+_NEXT
#define PIN_KIO1                            PIN_B8  //V-_PREV

#define ONE_KEY_MULTI_FUNC                  1       //多功能
...
#define PMU_CHARGE_CURRENT                  75      //设置充电电流，是充电时芯片耗电和充到电池的电流总和，单位:mA; 25-450mA,步进:25mA
#define PMU_VBUSIN_RESTART                  1       //使能VBUS插入后重启，常用于耳机方案
...
#define TIME_BEFORE_WFI                     1       //进入WFI阈值，单位:ms
...
#define AUTO_POWER_OFF                      1       //使能蓝牙断开自动关机，当蓝牙断开一段时间就会自动关机
...
#define DVFS_TONEMIXER_FREQ                 192000000
#define DVFS_A2DPAUDIO_FREQ                 192000000
#define DVFS_SCOAUDIO_FREQ                  192000000
#define DVFS_SCOAENC_FREQ                   192000000
#define DVFS_USBAUDIO_FREQ                  192000000
#define DVFS_LINEINAUDIO_FREQ               192000000
#define DVFS_LOCAL_ENCODE_WAV_FREQ          192000000
#define DVFS_LOCAL_ENCODE_MP3_FREQ          192000000
#define DVFS_LOCAL_DECODE_WAV_FREQ          192000000
#define DVFS_LOCAL_DECODE_MP3_FREQ          192000000
#define DVFS_DEFAULT_FREQ                   192000000
