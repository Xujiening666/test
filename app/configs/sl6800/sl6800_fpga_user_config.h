 ...
 *               scene mode config
 ***************************************************************************/
#define MODE_BT_EN                          1       //蓝牙模式
#define MODE_MUSIC_EN                       1       //本地音乐模式
#define MODE_RECORD_EN                      0       //录音模式
#define MODE_FM_EN                          1       //FM收音模式
...
#define VOLUME_DEFAULT                      30      //默认音量值
...
#define AUDIO_KARAOKE_MODE                  0       //卡拉OK功能
 ...
 */
#define AUDIO_USE_MUTE                      0
#define AUDIO_MUTE_PIN                      (PIN_B7)
 ...
 */
#define AUDIO_AMIC0_ANALOG_GAIN             10
#define AUDIO_AMIC1_ANALOG_GAIN             10
#define AUDIO_AMIC2_ANALOG_GAIN             10
...
#define BLE_ADDR_DEFAULT                    {0xFA,0xFB,0xFC,0xFD,0xFE,0xFF}     //BLE设备默认地址
#define BLE_NAME_DEFAULT                    "SL-BLE"                            //BLE设备默认名字

#define BT_RFPOWER_FORCE_EN                 0       //RF发送功率固定
#define BT_RFPOWER_FORCE_VAL                16      //RF发送功率固定的档位，范围：0~18，功率值：(-34+2*BT_RFPOWER_FORCE_VAL) dbm

#define BT_MAXPOWER_SET_EN                  0       //RF发送最大功率限制（在BT_RFPOWER_FORCE_EN是0时有效）
#define BT_MAXPOWER_SET_VAL                 16      //RF发送最大功率的档位，范围：0~18，功率值：(-34+2*BT_MAXPOWER_SET_VAL) dbm
...
#define RECORD_FORMAT_SEL                   1        //录音编码格式： 0:adpcm; 1:mp2; 2:sbc
...
#define LINEIN_DETECT_EN                    0       //line插入/拔出检测
#define LINEIN_DETECT_PIN_NUM               PIN_D0  //line检测gpio
...
#define FM_CLK_PIN_SEL                      1       //0:none; 1:PB12; 2:PB1; 3:PB8; 4:PB13; 5:PC4; 6:PD0;
...
#define SD_D0_PIN_SEL                       4       //2:PA17(SD,FPGA_1); 3:PB15(TF,FPGA_1);4:PB21(SD,FPGA_1)
#define SD_CLK_PIN_SEL                      4       //2:PA15(SD,FPGA_1); 3:PB13(TF,FPGA_1);4:PB19(SD,FPGA_1)
#define SD_CMD_PIN_SEL                      4       //2:PA16(SD,FPGA_1); 3:PB14(TF,FPGA_1);4:PA20(SD,FPGA_1)
#define SD_CLKDIV                           4       //0:no; 1:24MHz; 2:12MHz; 4:6MHz; 8:3MHz; 16:1.5MHz; 32:750KHz; 64:375KHz;
...
***************************************************************************/
#define TWI1_EN                             1
#define TWI1_SCL_PIN_SEL                    3       //0:PB0; 1:PD0; 2:PC1(FPGA); 3:PA5(FPGA_1)
#define TWI1_SDA_PIN_SEL                    3       //0:PB2; 1:PD1; 2:PC0(FPGA); 3:PA4(FPGA_1)
...
#define TWI2_EN                             0
#define TWI2_SCK_PIN_SEL                    3       //0:PB3; 1:PB12; 2:PD1; 3:PB1(FPGA_1)
#define TWI2_SDA_PIN_SEL                    3       //0:PB4; 1:PB13; 2:PD0; 3:PB2(FPGA_1)
#define TWI2_SD_SHARE_EN                    0       //TWI2与SD共用PB3/PB4
#define TWI2_DM_SHARE_EN                    0       //TWI2_SCK与USB_DM共用PB3
#if !TWI2_EN
...
#define SPI1_MISO_PIN_SEL                   1       //0:--; 1:PB8; 2:PB10; (仅在四线模式时用到)
...
#define PWM_CH0_PIN_SEL                     0       //0:PA15(FPGA); 1:PB5; 2:PB12
#define PWM_CH1_PIN_SEL                     0       //0:PA16(FPGA); 1:PB6; 2:PB13
#define PWM_CH2_PIN_SEL                     0       //0:PA17(FPGA); 1:PB7;
#define PWM_CH3_PIN_SEL                     0       //0:PA18(FPGA); 1:PB8; 2:PB10
#define PWM_CH4_PIN_SEL                     0       //0:PA19(FPGA); 1:PB9; 2:PB11; 3:PD1
#define PWM_CH5_PIN_SEL                     0       //0:PA20(FPGA); 1:PD0;

/***************************************************************************
 *               i2s config
 ***************************************************************************/
#define I2S0_EN                             1       //I2S模块
#define I2S0_BCLK_PIN_SEL                   2       //0:PB7; 1:PB4(FPGA); 2:PA13(FPGA_1);
#define I2S0_LRCK_PIN_SEL                   2       //0:PB6; 1:PB5(FPGA); 2:PA14(FPGA_1)
#define I2S0_TX_EN                          1
#define I2S0_TX_PIN_SEL                     2       //0:PB8; 1:PB6(FPGA); 2:PA11(FPGA_1)
#define I2S0_RX_EN                          0
#define I2S0_RX_PIN_SEL                     2       //2:PA12(FPGA_1);
#define I2S0_MCLK_EN                        1
#define I2S0_MCLK_PIN_SEL                   2       //2:PA10(FPGA_1);
...
#define UART0_SCLK_FREQ                     24000000
#define UART0_TX_PIN_SEL                    6       //0:PB1; 1:PB3; 2:PB6; 3:PB8; 4:PB9; 5:PD0; 6:PA0(FPGA);
#define UART0_RX_PIN_SEL                    3       //0:PB4; 1:PB10; 2:PD1; 3:PA1(FPGA)

#define UART1_EN                            0       //UART1模块
#define UART1_BAUDRATE                      115200  //波特率
#define UART1_HWFLOWCTL                     UART_HWCONTROL_NONE //流控
#define UART1_SCLK_FREQ                     24000000
#define UART1_FIFO_EN                       0
#define UART1_DMA_EN                        0
#define UART1_CTS_PIN_SEL                   4       //0:PB4; 1:PB11; 2:PB3(FPGA); 3:PA31(FPGA_1); 4:PA25(FPGA_1)
#define UART1_RTS_PIN_SEL                   4       //0:PB3; 1:PB10; 2:PB2(FPGA); 3:PA30(FPGA_1); 4:PA24(FPGA_1)
#define UART1_TX_PIN_SEL                    4       //0:PB12; 1:PD0; 2:PB0(FPGA); 3:PA28(FPGA_1); 4:PA22(FPGA_1)
#define UART1_RX_PIN_SEL                    4       //0:PB13; 1:PD1; 2:PB1(FPGA); 3:PA29(FPGA_1); 4:PA23(FPGA_1)

#define UART2_EN                            0       //UART2模块
#define UART2_BAUDRATE                      115200  //波特率
#define UART2_HWFLOWCTL                     UART_HWCONTROL_NONE //流控
#define UART2_SCLK_FREQ                     24000000
...
#define TONE_MUSIC_MODE_EN                  1       //音乐模式提示音
#define TONE_CLOCK_MODE_EN                  1       //clock模式提示音
#define TONE_FM_MODE_EN                     1       //FM模式提示音
#define TONE_LINEIN_MODE_EN                 0       //linein模式提示音
#define TONE_PC_MODE_EN                     1       //PC模式提示音
...
#define TONE_INCOMING_NUM_EN                1       //来电报号提示音
#define TONE_CALL_EN                        1       //来电铃声
#define TONE_ALARM_EN                       1       //闹钟提示音
#define TONE_MAX_VOLUME_EN                  1       //最大音量提示音
#define TONE_MIN_VOLUME_EN                  0       //最小音量提示音
#define TONE_LOW_POWER_EN                   0       //低电量提示音
#define TONE_BT_NEXT_EN                     1       //蓝牙模式下一首提示音
#define TONE_BT_PREV_EN                     1       //蓝牙模式上一首提示音
...
#define KEY_IR_EN                           1       //红外遥控按键
#define KEY_TOUCH_EN                        0       //触摸按键
#define KEY_CODING_EN                       0       //编码开关旋钮
#define KEY_UART_EN                         1       //从UART接收按键
#define KEY_PMU_EN                          0       //ONOFF用作p/p键
#define KEY_PMU_MULTFUC_EN                  0       //ONOFF用作多功能键（包括单击、双击、长按）

/***************************************************************************
 *               keyadc config
 ***************************************************************************/
#define KADC0_EN                            0       //PB9
...
#define KIO_GPIOC                           1       //使用PC组GPIO

#define PIN_KIO0                            PIN_C0
#define PIN_KIO1                            PIN_C1
#define PIN_KIO2                            PIN_C2
#define PIN_KIO3                            PIN_C3
#define PIN_KIO4                            PIN_C4
#define PIN_KIO5                            PIN_C5
#define PIN_KIO6                            PIN_C6
#define PIN_KIO7                            PIN_C7
 ...
 *               irrx config
 ***************************************************************************/
#define IRRX_PIN_SEL                        0       //0:PB0(FPGA); 1:PD1; 2:PC3;
...
//LED_DIGITAL:
#define LED0_PIN_SEL                        3       //0:B5; 3:A15
#define LED1_PIN_SEL                        3       //0:B6; 3:A16
#define LED2_PIN_SEL                        3       //0:B7; 3:A17
#define LED3_PIN_SEL                        3       //0:B8; 3:A18
#define LED4_PIN_SEL                        3       //0:B10; 3:A19
#define LED5_PIN_SEL                        3       //0:B0; 1:B11; 3:A20
#define LED6_PIN_SEL                        3       //0:B2; 1:B12; 3:A21
#define LED7_PIN_SEL                        0       //0:B13;
#define LED8_PIN_SEL                        0       //0:D0;

//LED_DIODE:
#define LED_RED_PIN_NUM                     (PIN_C8)
#define LED_BLUE_PIN_NUM                    (PIN_C9)
 ...
 *               pmu config
 ***************************************************************************/
#define PMU_CORE_USE_DCDC                   0       //HS系列使用DCDC给CORE供电，WS/CA系列使用LDO给CORE供电
...
#define PMU_LONG_PRESS_TIME                 3000    //设置长按时长，长按开机或者长按关机，单位:ms; 只能选择1000/2000/3000/4000ms
#define PMU_CHARGE_CURRENT                  200     //设置充电电流，是充电时芯片耗电和充到电池的电流总和，单位:mA; 25-450mA,步进:25mA
...
#define PMU_AVCC_VOLT                       2700    //设置AVCC电压，单位:mV， 2700~3400mV， 步进:100mV，会影响音频最大音量
 ...
 *               cpu freq config
 ***************************************************************************/
#define DVFS_KARAOKE_FREQ                   192000000
...
#define DVFS_LOCAL_ENCODE_WAV_FREQ          64000000
#define DVFS_LOCAL_ENCODE_MP3_FREQ          192000000
#define DVFS_LOCAL_DECODE_WAV_FREQ          64000000
